...
/****** Object:  StoredProcedure [hd_emenu].[sp_cart_product_readByTableIDAndLanguageID]    Script Date: 2016-03-13 3:11:50 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [hd_emenu].[sp_cart_product_readByTableIDAndLanguageID]
	@table_id int,
	@language_id int
AS 
BEGIN
